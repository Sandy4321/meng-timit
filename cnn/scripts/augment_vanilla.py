...
output_dir = os.path.join(os.environ["AUGMENTED_DATA_DIR"], "vanilla")
...
for source_class in decoder_classes:
    for target_class in decoder_classes:
        ...
        augment(train_loaders[source_class], augmented_dir, source_class, target_class)
        
        augment_end_t = time.clock()
        print("\nProcessed source %s, target %s in %.3fs" % (source_class,
                                                             target_class,
...
for source_class in decoder_classes:
    for target_class in decoder_classes:
        ...
        augment(dev_loaders[source_class], augmented_dir, source_class, target_class)
...
for source_class in decoder_classes:
    for target_class in decoder_classes:
        ...
        augment(test_loaders[source_class], augmented_dir, source_class, target_class)
