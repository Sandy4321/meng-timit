...
# Set up end2end model and associated checkpointing directory
...
for batch_idx, (feats, _, utt_ids) in enumerate(loader):
    ...
    # Splice in features for input to end2end_phone model
    ...
    # Compute log probabilities with end-to-end model and print to stdout
