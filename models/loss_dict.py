...
class LossDict(object):
    def __init__(self, decoder_classes, model_type):
        ...
        allowed_model_types = ["acoustic_model", "enhancement_net", "end2end_phone_net"]
